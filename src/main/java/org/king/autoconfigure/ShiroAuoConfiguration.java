...
import org.king.framework.shiro.realm.UserRealm;
import org.king.framework.shiro.session.OnlineSessionDAO;
import org.king.framework.shiro.session.OnlineSessionFactory;
import org.king.framework.shiro.web.filter.LogoutFilter;
import org.king.framework.shiro.web.filter.UserFilter;
import org.king.framework.shiro.web.filter.kickout.KickoutSessionFilter;
import org.king.framework.shiro.web.filter.online.OnlineSessionFilter;
import org.king.framework.shiro.web.filter.sync.SyncOnlineSessionFilter;
import org.king.framework.shiro.web.session.OnlineWebSessionManager;
import org.king.framework.shiro.web.session.SpringSessionValidationScheduler;
import org.king.framework.spring.ApplicationUtils;
import org.king.framework.springboot.properties.RememberMeCookie;
import org.king.framework.springboot.properties.ShiroProperties;
...
public class ShiroAuoConfiguration implements WebMvcConfigurer {
    ...
    public EhCacheManager getEhCacheManager() {
        net.sf.ehcache.CacheManager cacheManager = net.sf.ehcache.CacheManager.getCacheManager("King");
