...
import org.king.common.cons.QuartzCons;
...
public class QuartzManage {
    ...
    public void addJob(Job quartzJob) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "创建定时任务失败", e);
        }
    }
    ...
    public void updateJobCron(Job quartzJob) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "更新定时任务失败", e);
    ...
    public void deleteJob(Job quartzJob) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "删除定时任务失败", e);
    ...
    public void resumeJob(Job quartzJob) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "恢复定时任务失败", e);
        }
    }
    ...
    public void pauseJob(Job quartzJob) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "定时任务暂停失败", e);
        }
    }
}
