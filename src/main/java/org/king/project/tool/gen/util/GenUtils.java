package org.king.project.tool.gen.util;

import java.util.Arrays;

import org.king.common.cons.CommonMap;
...
public class GenUtils {
    ...
    public static void initTable(GenTable genTable, String operName) {
        String packagePath = Kings.getGenerator().getPackagePath();
        ...
        genTable.setFunctionAuthor(Kings.getGenerator().getAuthor());
