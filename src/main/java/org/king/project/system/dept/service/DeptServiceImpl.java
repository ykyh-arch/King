package org.king.project.system.dept.service;
...
import org.king.framework.web.domain.Ztree;
import org.king.project.system.dept.domain.Dept;
import org.king.project.system.dept.mapper.DeptMapper;
...
public class DeptServiceImpl extends BaseServiceImpl<DeptMapper, Dept> implements IDeptService {
    ...
    public boolean insertDept(Dept dept) {
        ...
        if (!UserConstants.DEPT_NORMAL.equals(info.getStatus())) {
            throw new KingException(HttpServletResponse.SC_BAD_REQUEST, "部门停用，不允许新增");
        }
