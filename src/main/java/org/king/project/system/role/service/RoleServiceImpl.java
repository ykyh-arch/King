package org.king.project.system.role.service;
...
import org.king.project.system.role.mapper.RoleMapper;
import org.king.project.system.user.domain.UserRole;
import org.king.project.system.user.service.IUserRoleService;
    ...
    public boolean deleteRoleByIds(String ids) {
        ...
        for (Long roleId : roleIds) {
            ...
            if (userRoleService.query().eq(UserRole::getRoleId, roleId).exist()) {
                throw new KingException(HttpServletResponse.SC_BAD_REQUEST, role.getRoleName() + "已分配，不能删除");
            }
        }
