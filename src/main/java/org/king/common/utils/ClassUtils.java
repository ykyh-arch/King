...
public abstract class ClassUtils {
    ...
    public static <T> T newInstance(Class<T> clazz) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "创建新的实例异常，Class：" + (clazz == null ? "null" : clazz.getName()), e);
        }
    }
    ...
    public static Class<?> forName(String clazz) {
        try {
            ...
            throw new KingException(HttpServletResponse.SC_INTERNAL_SERVER_ERROR, "无法根据名称获取Class，String class [" + clazz + "]", e);
        }
    }
    ...
    public static Class<?> getUserClass(Object object) {
        if (Objects.isNull(object)) {
            throw new KingException(HttpServletResponse.SC_BAD_REQUEST, "实例不能为空");
        }
